  ...
  const handleFileLoad = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (e: ProgressEvent<FileReader>) => {
      ...
      try {
        ...
        await dispatch(setData(jsonData)); // Dispatch the loaded data
        
        // Redirect to the report tab
        // Update this URL to the correct path for your report tab, including dynamic segments if necessary
    ...
    if (router.isReady) {
      router.push(`/${locale}/report`).catch(console.error);
    }
